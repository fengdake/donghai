...
// 行业管理
const queryMxglHymxTreeList = (params)=>getAction("/business/mxglHymx/queryTreeList",params);
const searchMxglHymxByKeywords   = (params)=>getAction("/business/mxglHymx/searchBy",params);
const deleteMxglHymxByDepartId   = (params)=>deleteAction("/business/mxglHymx/delete",params);
...
export const ajaxGetSelectItems = (code, params)=>getAction(`/sys/dict/getSelectValues/${code}`,params);
...
export {
  ...
  queryMxglHymxTreeList,
  searchMxglHymxByKeywords,
  deleteMxglHymxByDepartId
}
