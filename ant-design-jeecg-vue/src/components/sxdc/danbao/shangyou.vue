<template>
  <a-card :bordered="false">
    ...
    <!-- 表单区域 -->
    <SxdcSygys ref="modalForm" :sxid="sxid" @ok="modalFormOk"></SxdcSygys>
  </a-card>
</template>

<script>
  import SxdcSygys from './model/SxdcSygysModal'
  ...
  export default {
    ...
    data () {
      return {
		...
		url: {
          list: "/business/sxdcSygys/list",
          delete: "/business/sxdcSygys/delete",
          deleteBatch: "/business/sxdcSygys/deleteBatch",
          exportXlsUrl: "business/sxdcSygys/exportXls",
          importExcelUrl: "business/sxdcSygys/importExcel",
       },
    }
  },
  computed: {
