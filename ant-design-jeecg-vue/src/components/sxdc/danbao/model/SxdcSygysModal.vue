    ...
    <a-spin :spinning="confirmLoading" style="height:600px;overflow-y: auto;">
      <a-form :form="form">
        <a-form-item style="margin-bottom:13px;"
          ...
          label="供应商名称">
          <a-input placeholder="请输入供应商名称" v-decorator="['mc', validatorRules.v1]" />
        </a-form-item>
        <a-form-item style="margin-bottom:13px;"
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
        ...
        <a-form-item style="margin-bottom:13px;"
          ...
          :wrapperCol="wrapperCol"
          label="采购比例">
          <a-input placeholder="请输入采购比例" v-decorator="['cgbl', validatorRules.v3]" />
        </a-form-item>
        <a-form-item style="margin-bottom:13px;"
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/business/sxdcSygys/add",
          edit: "/business/sxdcSygys/edit",
        },
      }
    },
    created () {
      //console.log('这是传来的sxid'+this.sxid)
    },
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'mc','sfzhm','cgbl','jsqd','jszq','wlsj','sfwhkh','jydz','jyxm','jzc','lxdh','delFlag','description'))
		  //时间格式化
        });
      ...
      handleOk () {
        ...
        this.form.validateFields((err, values) => {
          if (!err) {
            ...
            //console.log( Object.assign(this.model, values) )
