...
<!-- 2 -->
          <div class="jindub"  v-if="item.sfjs != 1">
            <img class="tupian"   src="@/assets/sxspjd_b.png" />
          </div>
          <div class="jindujieshu" v-if="item.sfjs != 0">
        ...
        <div style="height:140px">
          <div class="jinduc">
            <p class="jinduc_a">审核人: {{item.shhjshr}}</p>
...
export default {
  ...
  methods: {
    dakai(e) {
      ...
      getAction('/business/hGYgxwPcb/shjllist', obj).then(res => {
        //console.log(res)
        if (res.success == true) {
