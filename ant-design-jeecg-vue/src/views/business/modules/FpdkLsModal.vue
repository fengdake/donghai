    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item
          ...
          :wrapperCol="wrapperCol"
          label="贷款YT">
          <a-input placeholder="请输入贷款YT" v-decorator="['dkyt', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
        ...
        <a-form-item
          ...
          :wrapperCol="wrapperCol"
          label="贷款总额">
          <a-input placeholder="请输入贷款总额" v-decorator="['dkze', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/business/fpdkLs/add",
          edit: "/business/fpdkLs/edit",
        },
      }
    },
    created () {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'khh','khmc','ghjl','sjwhjg','dkzh','dkyt','zjhm','dkze','zh','kh','jylx','jysj','jffse','dffse','ye','gyh','dfxm','dfzh','bz'))
		  //时间格式化
