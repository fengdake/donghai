        ...
        <div class="zhuti">
          <div class="zhuti_left">
            ...
            <dl class="menu-child" v-show="name=='影像资料'">
              ...
              <dt  class="dt" style="padding-left: 3em;"><img data-v-618a06bc="" src="data:image/png;base64,">资料类型
          </dt>
              <dd
                class="dd"
          ...
          <div class="zhuti_right">
            ...
            <!-- 基本资料 -->
            <jbxx v-show="name=='基本信息'" :jcjd="jcjd" ref="jibenziliao" :zjhm="zjhm" :see="see" :leiXing='leiXing'></jbxx>
            <!-- 影音资料 -->
            ...
            <!-- 现金流 -->
            <xianjinliu v-show="name=='现金流'" ref="xianjin" :zjhm="zjhm" ></xianjinliu>
            <!-- 现场检索表 -->
            <xianjsb v-show="name=='现场检验表'" ref='xianChangjianyan' :see="see"></xianjsb>
            <!-- 分析结论 -->
            <fxjlxian v-show="name=='分析结论'" :jcjd="jcjd" :zjhm="zjhm" :see="see" ref="fenxijielun"></fxjlxian>
          </div>
        </div>
      </div>
    </template>
...
export default {
  ...
  methods: {
    ...
    getyingyin() {
      ...
      getAction('/business/dhglJjKhxcyxzl/list', obj).then(res => {
        if (res.success == true) {
          console.log(res)
...
@keyframes myfirst
{
0%   {border:1px solid #ededed;}
100% {border: dashed 1px rgba(73, 160, 237, 1);}
}
.tupian{
