    ...
    <div class="zhengxinaa" :style="'min-height:'+gaodu+'px'" style="width:90%;margin:0 auto;">
      <div class="biaoge" style="margin:0px;">
        ...
        <div class="qingbei_biao">
          ...
          <p class="qingbei_biao_a">
            ...
            <span class="qingbei_biao_b">行政村数量</span>
            <span class="qingbei_biao_c">
              <span class="chakan" @click="cunluo">21</span>
            </span>
          </p>
          <p class="qingbei_biao_a">
            <span class="qingbei_biao_b">总面积</span>
            <span class="qingbei_biao_c">169.89平方公里</span>
            <span class="qingbei_biao_b">我行客户</span>
            <span class="qingbei_biao_c">1500人</span>
          </p>
          <p class="qingbei_biao_a">
            <span class="qingbei_biao_b">平均年龄</span>
      ...
      <div class="nextbiao">
        <div class="nextbiao_a">
          <p class="biaogea">
            <img src="../../../assets/dizhic.png" alt />存款占比
          </p>
          <div class="nextbiaoa">
        ...
        <div class="nextbiao_b">
          <p class="biaogea">
            <img src="../../../assets/dizhic.png" alt />贷款占比
          </p>
          <div class="nextbiao_b_a">
            <p class="nextbiao_b_a_a">
              ...
              <span>
                客户数:
                <a class="shuzi" style="margin-right:16px;">100</a>客户数:
                <a class="shuzi">100</a>
              </span>
            </p>
            <a-progress strokeLinecap="square" :percent="33" />
          </div>
          <div class="nextbiao_b_a">
            <p class="nextbiao_b_a_a">
              <span>电商贷</span>
            ...
            <a-progress strokeLinecap="square" :percent="20" />
          </div>
          <div class="nextbiao_b_a">
            <p class="nextbiao_b_a_a">
              <span>装修贷</span>
            ...
            <a-progress strokeLinecap="square" :percent="15" />
          </div>
          <div class="nextbiao_b_a">
            <p class="nextbiao_b_a_a">
              <span>晶都易贷</span>
          ...
          <div class="nextbiao_b_a">
            ...
            <a-progress strokeLinecap="square" :percent="10" />
          </div>
          <div class="nextbiao_b_a">
            <p class="nextbiao_b_a_a">
              <span>阳光贷款</span>
...
<script>
import cun from './cunModal'
import czdzyhkh from './czdzyhkh'
export default {
  name: 'zonghangModal',
  components: {
    cun,
