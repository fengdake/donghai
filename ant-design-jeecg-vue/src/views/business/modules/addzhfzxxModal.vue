<template>
  ...
  >
    <a-spin :spinning="confirmLoading">
      ...
      :wrapper-col="{ span: 12 }" :wrapperCol="wrapperCol" label="客户经理"   style="margin-bottom: 13px;">
          <a-input placeholder="" v-decorator="['xzbh', {}]" />
        </a-form-item>
        <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="新增村落"  style="margin-bottom: 13px;">
