<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      <a-button type="primary" icon="download" @click="handleExportXls('对公征信贷后管理查询登记簿')">导出</a-button>
    </div>
...
<script>
    ...
    export default {
        name: "DhglDgzxcxdjbList",
        mixins: [JeecgListMixin],
        components: {
        },
        data() {
            return {
                description: '贷后-季检-对公征信贷后管理查询登记簿管理页面',
                // 表头
                columns: [
                    {
                        title: '序号',
                ...
                url: {
                    list: "/zx/dhglZxcxgl/dglist",
                    exportXlsUrl: "zx/dhglZxcxgl/exportDgXls",
                },
            }
        },
        computed: {
