<template>
  <a-card :bordered="false">
      ...
      <a-form  layout="inline">
        <a-row :gutter="24">
          ...
          <template v-if="toggleSearchStatus">
            <a-col :md="6" :sm="8">
              <a-form-item label="信用卡已用金额" >
                <div  class="qujian-box">
                  <a-input class="qujian-input" placeholder v-model="queryParam.ysyedV_begin"></a-input>~
                  <a-input class="qujian-input" placeholder v-model="queryParam.ysyedV_end"></a-input>
                </div>
              </a-form-item>
            </a-col>
            <a-col :md="6" :sm="8">
              <a-form-item label="贷款余额" >
                <div  class="qujian-box">
                  <a-input class="qujian-input" placeholder v-model="queryParam.ye_begin"></a-input>~
                  <a-input class="qujian-input" placeholder v-model="queryParam.ye_end"></a-input>
                </div>
              </a-form-item>
            </a-col>
            <a-col :md="6" :sm="8">
              <a-form-item label="担保贷款余额" >
                <div class="qujian-box">
                  <a-input class="qujian-input" placeholder v-model="queryParam.dbdkye_begin"></a-input>~
                  <a-input class="qujian-input" placeholder v-model="queryParam.dbdkye_end"></a-input>
                </div>
              </a-form-item>
            </a-col>
          </template>
    ...
    <div>
      ...
      >
        <template slot="zjhmv" slot-scope="text,record">
          <a @click="dianji(text,record)" >{{text}}</a>
        </template>

        <template slot="jszjhmv" slot-scope="text,record">
          <a @click="dianji(text,record)" >{{text}}</a>
        </template>
      </a-table>
    </div>
    ...
    return {
      ...
      columns: [
        ...
        },
        {
          ...
          width:200,
          dataIndex: 'zjhmv',
          scopedSlots: { customRender: 'zjhmv' },
        },
        {
          title: '性别',
          align: 'center',
        ...
        },
        {
        ...
        },
         {
          ...
          align: 'center',
           width:200,
          dataIndex: 'jszjhmv',
           scopedSlots: { customRender: 'jszjhmv' },
        },
        {
          title: '信用卡已使用金额',
          align: 'center',
