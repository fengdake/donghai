<template>
  <a-card :bordered="false">
    ...
    <!-- 表单区域 -->
    <Czwt-modal ref="modalForm" @ok="modalFormOk"/>
  </a-card>
</template>
  ...
  export default {
    ...
    data() {
      return {
        ...
        url: {
          list: "/hg2/wbjc/listCzwtByMainId",
          delete: "/hg2/wbjc/deleteCzwt",
          deleteBatch: "/hg2/wbjc/deleteBatchCzwt",
        }
      }
    },
    methods: {
      ...
      handleAdd: function () {
        ...
        this.$refs.modalForm.title = "添加合规检查-外部检查-存在问题";
      },
    }
  }
</script>
