...
<script>
import JcssXcxfzgtzsCzwtModal from './modules/zgtzsaddCzwtModal'
...
export default {
  ...
  data() {
    return {
      ...
      url: {
        list: '/hg2/zgtzsJcxxCzwt/list?pid='+this.id,
        delete: '/hg2/zgtzsJcxxCzwt/delete',
        deleteBatch: '/hg2/zgtzsJcxxCzwt/deleteBatch',
        exportXlsUrl: 'hg2/zgtzsJcxxCzwt/exportXls',
        importExcelUrl: 'hg2/zgtzsJcxxCzwt/importExcel'
      }
    }
  },
  props: ['id','see'],
  ...
  methods: {
    ...
    handleDelete(id){
      ...
      deleteAction('/hg2/zgtzsJcxxCzwt/delete', obj).then((res) => {
        if (res.success == true) {
