      ...
      <div :style="persryle">
        ...
        <div class="zhuti">
          ...
          <div class="zhuti_right">
            <!-- 整改报告 -->
            <zgbg v-show="name=='整改报告'" ref="bg" :id="id" :see="see"></zgbg>
          </div>
        </div>
      </div>
    </template>
...
import zgbg from './zgbgChild' //报告信息
...
export default {
  ...
  methods: {
    ...
    _biglist(e) {
      ...
      console.log(e)
      if (this.biglist[e].name == '整改报告') {
        this.$refs.bg.getchuju()
      }
