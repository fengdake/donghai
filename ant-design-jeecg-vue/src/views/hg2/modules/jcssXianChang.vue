...
import wenti from '../JcssXcxfzgtzsCzwtList' //存在问题
...
export default {
  ...
  methods: {
    ...
    getchuju() {
      ...
      this.spinning = true
      getAction('/hg2/jcssXcxfzgtzs/queryByPid', obj)
        .then(res => {
          console.log(res)
          if (res.success == true) {
    ...
    add() {
      ...
      this.loading = true
      postAction('/hg2/jcssXcxfzgtzs/add', obj)
        .then(res => {
          console.log(res)
          if (res.success == true) {
            this.xianchangid = res.result.id
    ...
    edit() {
      ...
      this.loading = true
      putAction('/hg2/jcssXcxfzgtzs/edit', obj)
        .then(res => {
          console.log(res)
          if (res.success == true) {
            this.$notification.success({
