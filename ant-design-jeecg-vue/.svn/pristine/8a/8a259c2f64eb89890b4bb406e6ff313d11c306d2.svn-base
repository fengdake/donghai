...
export default {
  ...
  methods: {
    ...
    getchuju() {
      ...
      this.spinning = true
      getAction('/hg2/jcssFxcxfzgtzs/queryByPid', obj)
        .then(res => {
          console.log(res)
          if (res.success == true) {
            this.feixianchangid = res.result.id
    ...
    //点击保存
    baocun() {
      if (this.feixianchangid == null || this.feixianchangid == '') {
        this.add() //添加
      } else {
        this.edit() //修改
      }
    ...
    add() {
      ...
      this.loading = true
      postAction('/hg2/jcssFxcxfzgtzs/add', obj)
        .then(res => {
          console.log(res)
          if (res.success == true) {
            this.feixianchangid = res.result.id
    ...
    edit() {
      ...
      this.loading = true
      putAction('/hg2/jcssFxcxfzgtzs/edit', obj)
        .then(res => {
          console.log(res)
          if (res.success == true) {
            this.$notification.success({
