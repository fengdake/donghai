    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item
          ...
          :wrapperCol="wrapperCol"
          label="账号/卡号">
          <a-input placeholder="请输入账号/卡号" v-decorator="['zh', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/business/ycxwZhycjy/add",
          edit: "/business/ycxwZhycjy/edit",
        },
      }
    },
    created () {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'hydh','hymc','jsgx','jsxm','zjhm','zh','jyrq','jysj','jyje','dfxm'))
		  //时间格式化
        });
