    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item
          ...
          :wrapperCol="wrapperCol"
          label="家属名称">
          <a-input placeholder="请输入家属名称" v-decorator="['jsmc', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
          label="问题行为">
          <a-input placeholder="请输入问题行为" v-decorator="['wtxw', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
          label="数据来源表名">
          <a-input placeholder="请输入数据来源表名" v-decorator="['tabname', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
          label="附件">
          <a-input placeholder="请输入附件" v-decorator="['fj', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/business/hGYcxwHzb/add",
          edit: "/business/hGYcxwHzb/edit",
        },
      }
    },
    created () {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'hydh','hymc','jsgx','jsmc','wtxw','tabname','fj','bz','zt'))
		  //时间格式化
