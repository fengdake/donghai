    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item
          ...
          :wrapperCol="wrapperCol"
          label="调查类型">
          <a-input placeholder="请输入调查类型" v-decorator="['dclx', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/business/sxspdyGrdk/add",
          edit: "/business/sxspdyGrdk/edit",
        },
      }
    },
    created () {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'sqrxm','sfzh','xb','lxfs','jzdz','dclx','slzh','delFlag','description'))
		  //时间格式化
        });
