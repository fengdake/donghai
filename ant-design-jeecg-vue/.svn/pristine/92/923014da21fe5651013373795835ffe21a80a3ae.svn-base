      ...
      <a-card :bordered="false">
        ...
        <div class="table-page-search-wrapper">
          ...
          <a-form layout="inline">
            <a-row :gutter="24">
              <a-col :md="6" :sm="8">
                <a-form-item label="人员名称" :labelCol="{span: 5}" :wrapperCol="{span: 18, offset: 1}">
                  <a-input placeholder="请输入人员名称" v-model="queryParam.realname"></a-input>
                </a-form-item>
              </a-col>
              <a-col :md="6" :sm="8">
                <a-form-item label="人员账户" :labelCol="{span: 5}" :wrapperCol="{span: 18, offset: 1}">
                  <a-input placeholder="请输入人员账户" v-model="queryParam.username"></a-input>
                </a-form-item>
              </a-col>
              <!-- <a-col :md="6" :sm="8">
                <a-form-item label="对应职位">
                  <a-select
                    style="width: 100%"
                    placeholder="请选择对应职位" v-model="queryParam.pid">
            ...
            <a-col :md="12" :sm="24">
              ...
              <!-- <a-button type="primary" class="moBan" icon="download" @click="handleExportXls">导出</a-button> -->
            </a-col>
          </span>
            </a-row>
          </a-form>
        ...
        <div class="table-operator" style="">
          ...
          <!-- <a-button @click="handleAdd" type="primary" icon="plus">岗位录入</a-button>
          <a-button @click="handleEdit(model1)" type="primary" icon="plus">岗位编辑</a-button>
        ...
        <div style="margin-top: 15px">
          ...
          <span slot="action" slot-scope="text, record">
                <a title="确定删除吗?" @click="handleDelete1(record)">
                  删除
                </a>       
        </span>
          </a-table>
...
<script>
  ...
  import SelectUserModal from './modules/chooseUserModal'
  ...
  export default {
    ...
    data() {
      return {
        ...
        url: {
          list: '/hggly/userlist',
          delete: '/hggly/deletehggly',
          list2: '/sys/user/userRoleList',
          addUserRole: '/hggly/addSysUserRole',
    ...
    methods: {
      ...
      handleDelete1: function(data) {
       ...
       if(confirm("确定删除吗"))
       {
        ...
        var that = this
        deleteAction(that.url.delete, { roleId: data.roleId, id: data.id }).then((res) => {
          if (res.success) {
      ...
      handleAddUserRole() {
        this.currentRoleId='0533791df0022797244fe2c92e628e43';
        if (this.currentRoleId == '') {
          this.$message.error('请选择一个岗位!')
        } else {
