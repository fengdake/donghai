  ...
  methods: {
    ...
    baocunzxcx() {
      ...
      if (this.zxchenshu == true) {
        if (this.zXCXPeiOu.cs == '' || this.zXCXPeiOu.cs == null) {
          this.loading = false
          this.spinning = false
      ...
      if (this.zxvalue == this.zXCXPeiOu.yzxshjl) {
        this.zXCXPeiOu.cs = ''
      }
      let obj = {
        sxid: this.zXCXPeiOu.sxid,
        zxshjl: this.zxvalue,
        blyyms: this.zXCXPeiOu.blyyms,
        cs: this.zXCXPeiOu.cs,
