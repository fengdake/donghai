...
export default {
  ...
  methods: {
    ...
    getchuju() {
      ...
      this.spinning = true
      getAction('/hg2/jcssWfxwt/queryByPid', obj)
        .then(res => {
          console.log(res)
          if (res.success == true) {
            this.wfxid = res.result.id
    ...
    add() {
      ...
      this.loading = true
      postAction('/hg2/jcssWfxwt/add', obj)
        .then(res => {
          console.log(res)
          if (res.success == true) {
            this.wfxid = res.result.id
    ...
    edit() {
      ...
      this.loading = true
      putAction('/hg2/jcssWfxwt/edit', obj)
        .then(res => {
          console.log(res)
          if (res.success == true) {
            this.$notification.success({
