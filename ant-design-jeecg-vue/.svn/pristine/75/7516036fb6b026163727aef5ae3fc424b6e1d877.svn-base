    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item style="margin-bottom:13px;"
          ...
          :wrapperCol="wrapperCol"
          label="排序">
          <a-input-number  style="width:368px;" v-decorator="[ 'px', {}]" />
        </a-form-item>
        <a-form-item style="margin-bottom:13px;"
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
          label="提示文本">
          <a-input placeholder="请输入提示文本" v-decorator="['tswb', {}]" />
        </a-form-item>
        <a-form-item style="margin-bottom:13px;"
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
        ...
        <a-form-item style="margin-bottom:13px;"
          ...
          :wrapperCol="wrapperCol"
          label="规则SQL">
          <a-textarea placeholder="请输入规则SQL" v-decorator="['gzsql', {}]" />
        </a-form-item>
        <a-form-item style="margin-bottom:13px;"
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/business/mxglKzmx/add",
          edit: "/business/mxglKzmx/edit",
        },
      }
    },
    created () {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'bm','mc','zt','px','tswb','nr','gzsql','bz','delFlag','description'))
		  //时间格式化
        });
