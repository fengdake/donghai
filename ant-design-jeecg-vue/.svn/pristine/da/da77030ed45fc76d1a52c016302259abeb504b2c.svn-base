<template>
  <div>
    <a-spin :spinning="spinning">
      <div class="jia_top">
        <a-button type="primary" icon="save" @click="baocun" v-show="seediaocha==false">保存</a-button>
      </div>
      <div class="xianjin" style="margin-top: 24px;">
        ...
        <div style="width:100%;overflow-x: auto;">
          <div class="jinyia">
            <div class="dailuanliebiao_a" style="width:409px;height:130px;margin-left:0px;">
              ...
              <div class="dailuanliebiao_b" style="height: 56px;">
                <div>
                  ...
                  <p class="dailuanliebiao_b_a" style="color:#49a0ed;" @click="shijitan('流入',yuefen[12])">{{xianJinLiuRuZongJi}}<a-icon type="paper-clip" /></p>
                </div>
                <div>
                  <p class="dailuanliebiao_a_b">流出</p>
                  <p class="dailuanliebiao_b_a" style="color:#ff4747;" @click="shijitan('流出',yuefen[12])">{{xianjinLiuChuZongJi}}<a-icon type="paper-clip" /></p>
                </div>
              </div>
            </div>
            <div class="xinjinmiao1">
              ...
              <a-textarea
                placeholder
                autosize
                style="height: 108px;font-size: 14px;"
                v-model="desc.xjlfx"
                :disabled="!seediaocha"
              />
            </div>
      ...
      <xianjintan ref="xianjintan" :sfzh="sfzh"></xianjintan>
    </a-spin>
  </div>
</template>
<script>
...
import xianjintan from '../../sxdc/danbao/xianjintan'
...
export default {
  ...
  props: ['seediaocha', 'sxid', 'taskid', 'sfzh'],
  ...
  methods: {
    shijitan(e, b) {
      console.log( b )
      this.$refs.xianjintan.dakai(e, b)
    },
    getxjl() {
      let obj = {
        zjhm: this.sfzh,
