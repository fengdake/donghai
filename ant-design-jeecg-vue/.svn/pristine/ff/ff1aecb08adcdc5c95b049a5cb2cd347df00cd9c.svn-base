<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button type="primary" class="moBan" icon="download" @click="handleExportXls('合规-异常行为-员工与借款人担保人资金往来')">导出</a-button>
...
<script>
  ...
  export default {
    ...
    data () {
      return {
        description: '合规-异常行为-员工与借款人担保人资金往来管理页面',
        // 表头
        columns: [
          {
            title: '序号',
		...
		url: {
          list: "/business/ycxwJkrzjwl/list",
          delete: "/business/ycxwJkrzjwl/delete",
          deleteBatch: "/business/ycxwJkrzjwl/deleteBatch",
          exportXlsUrl: "business/ycxwJkrzjwl/exportXls",
          importExcelUrl: "business/ycxwJkrzjwl/importExcel",
       },
    }
  },
  computed: {
