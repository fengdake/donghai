      ...
      <div :style="persryle">
        ...
        <div class="zhuti">
          ...
          <div class="zhuti_right">
            <xejbxx v-show="name=='基本信息'" ref="jiben" :listid="listid" :id="id" :cha="cha"></xejbxx>
            <xedcxm v-show="name=='调查项目'" ref="diaocha" :id="id" :cha="cha"></xedcxm>
            <xefljg v-show="name=='分类结果'" ref="fenlei" :id="id" :cha="cha"></xefljg>
          </div>
        </div>
      </div>
    </template>
