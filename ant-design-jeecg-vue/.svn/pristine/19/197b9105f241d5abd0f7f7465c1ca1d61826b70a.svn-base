    ...
    <a-spin :spinning="confirmLoading">
      ...
      <a-form :form="form" v-show=" chakan == false">
        <a-row>
          ...
          <a-col :span="6" :gutter="8">
            <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="笔数">
              <a-input placeholder="请输入笔数" v-decorator="['bs', {}]" />
            </a-form-item>
          </a-col>
          <a-col :span="6" :gutter="8">
            <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="违规积分合计">
              <a-input placeholder="请输入违规积分合计" v-decorator="['wgjfHj', {}]" />
            </a-form-item>
          </a-col>
          <a-col :span="6" :gutter="8">
            <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="上传人员工号">
        ...
        <a-row>
          <a-col :span="6" :gutter="8">
            <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="上传人员姓名">
              <a-input placeholder="请输入上传人员姓名" v-decorator="['scrXm', {}]" />
            </a-form-item>
          </a-col>
          <a-col :span="6" :gutter="8">
            <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="上传部门代码">
              <a-input placeholder="请输入上传部门代码" v-decorator="['scbmDm', {}]" />
            </a-form-item>
          </a-col>
          <a-col :span="6" :gutter="8">
            <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="上传部门名称">
              <a-input placeholder="请输入上传部门名称" v-decorator="['scbmMc', {}]" />
            </a-form-item>
          </a-col>
          <a-col :span="6" :gutter="8">
            <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="上传日期">
              <a-date-picker placeholder="请输入上传日期" style="width:100%" v-decorator="[ 'scrq', {}]" />
            </a-form-item>
          </a-col>
        </a-row>
      </a-form>
